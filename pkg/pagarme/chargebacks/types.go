...
// DateCreated -> Filtro pela data de criação do chargeback
...
// DateUpdated -> Filtro pela data de atualização do chargeback
...
// TransactionID -> Filtro pelo ID da transação referida pelo chargeback
